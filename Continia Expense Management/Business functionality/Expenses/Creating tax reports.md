...
1. On the action bar, select **Report** > **Tax Report**.
1. Fill out the fields as necessary.
1. At the bottom, select:
...
Export the expense attachments of posted expenses as supporting documentation for tax authorities.
