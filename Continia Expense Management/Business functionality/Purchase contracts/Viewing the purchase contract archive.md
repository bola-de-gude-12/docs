---
title: Expense Management Viewing the Purchase Contract Archive
date: 01-04-2023
description:  
id: EM-134
lang: en
...
You can easily access the archive whenever you want if you need it for statistical or other purposes. 

To access the purchase contract archive:

1. Select the {{search}} icon, enter **Purchase Contracts**, and then select the related link to open the **Purchase Contracts** page.
1. In the list of contracts, select the one whose history you want to view.
1. On the action bar, select **Contract** > **Archive History**.
