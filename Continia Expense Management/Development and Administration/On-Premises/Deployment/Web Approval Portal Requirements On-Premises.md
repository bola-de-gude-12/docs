...
This article lists the requirements for using the Web Approval Portal with Microsoft Dynamics 365 Business Central *on-premises*. You can find the _online_ requirements [here](/continia-expense-management/getting-started/troubleshooting-and-faqs/minimum-requirements#continia-web-approval-portal).
...
> [!NOTE]
> Security filters are currently not supported in the Web Approval Portal. If you want to control what's visible and accessible to users in the portal, use account and dimension permissions instead. 
...
##See also
[Minimum Requirements for Using Continia Expense Management On-Premises](Minimum Requirements.md)  
