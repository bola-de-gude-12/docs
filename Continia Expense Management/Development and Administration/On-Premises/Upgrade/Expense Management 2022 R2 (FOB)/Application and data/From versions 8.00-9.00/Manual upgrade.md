---
title: Expense Management Manual Upgrade from Versions 8.00–9.00 to Version 10.00
date: 31-03-2025
id: EM-101
lang: en
...
With Continia Document Capture 10.00 and Continia Expense Management 10.00, Continia Software is releasing an upgrade guide that our partners can use to upgrade directly from Document Capture 8.00-9.00 and/or Expense Management 8.00-9.00 to Document Capture 10.00 and/or Expense Management 10.00.
...
Migration from FOB-based version of NAV/BC to an on-premises extension and/or online: See [Upgrading NAV/Business Central with Expense Management Installed](../../../../../../../Continia%20Expense%20Management/Development%20and%20Administration/On-Premises/Upgrade/Expense%20Management%202022%20R2%20\(FOB\)/Application%20and%20data/From%20versions%208.00-9.00/@EM-107/) and [Migrating Expense Management from Business Central On-Premises to Cloud](../../../../../../../Continia%20Expense%20Management/Development%20and%20Administration/On-Premises/Upgrade/Expense%20Management%202022%20R2%20\(FOB\)/Application%20and%20data/From%20versions%208.00-9.00/@EM-112/).
...
Ensure the current system is running one of the supported versions of Document Capture or Expense Management listed in the summary section. If not, it is very important that you follow the upgrade guide from an earlier version to DC4.50 and or EM2.60. Previous upgrade guides can be found [here](../../../../../../../Continia%20Expense%20Management/Development%20and%20Administration/On-Premises/Upgrade/Expense%20Management%202022%20R2%20\(FOB\)/Application%20and%20data/From%20versions%208.00-9.00/@EM-99/).
...
Import the new DC10.00/EM10.00 objects from the product folder. Use “**Replace All**” in Import Worksheet. Some objects may show a warning during import as some parts of the new Version List have changed format. Set Synchronize Schema to “**Later**” during object import.
