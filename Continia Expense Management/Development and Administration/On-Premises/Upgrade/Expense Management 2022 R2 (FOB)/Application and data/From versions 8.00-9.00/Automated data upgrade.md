---
title: Expense Management Automated Data Upgrade from Version 8.00-9.00 to Version 10.00
date: 31-03-2025
description:
id: EM-108
lang: en
...
> [!IMPORTANT]
> Note that Document Capture 2022 R2 (10.00) and Expense Management 2022 R2 (10.00) are only available if you're using Business Central April 2019 (v14, FOB-based) or newer versions. This means that clients using older NAV/BC versions will not be able to upgrade to DC10.00/EM10.00. Instead, they must upgrade to DC8.00/EM8.00, as these versions will continue to be supported with service packs.
...
If you are looking for the manual Pre and Post Upgrade process, refer to [Manual Upgrade from Version 8.00-9.00 to Version 10.00](@EM-101).
...
Ensure that the current system is running one of the supported versions of Document Capture or Expense Management listed in the summary section. If not, it is very important you follow the upgrade guide from an earlier version to DC8.00-9.00 and or EM8.00-9.00. Previous upgrade guides can be found [here](@EM-99).
