---
title: Upgrading to Continia Expense Management 2023 R1 (11.00) for FOB versions
date: 30-03-2023
description:  
id: EM-145
lang: en
...
# Upgrading to Continia Expense Management 2023 R1 (11.00) for FOB versions
...
The table below enables you to determine exactly what tasks must be carried out for your particular scenario in order for you to upgrade your old version of Expense Management to Expense Management 2023 R1 (11.00).
...
## Upgrade to Expense Management 2023 R1 (11.00)
...
| Full upgrade from the following versions: <ul><li>Expense Management 8.00</li><li>Expense Management 9.00</li><li>Expense Management 10.00</li></ul> | From these versions, you can upgrade directly to EM11.00 using [this guide](@EM-150). |
