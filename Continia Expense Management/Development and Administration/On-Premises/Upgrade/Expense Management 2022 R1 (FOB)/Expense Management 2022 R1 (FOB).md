---
title: Upgrading to Continia Expense Management 2022 R1 (9.00) for FOB versions
date: 01-03-2022
description:  
id: EM-74
lang: en
...
The table below enables you to determine exactly what tasks must be carried out for your particular scenario in order for you to upgrade your old version of Expense Management to Expense Management 2022 R1 (9.00).

##Upgrade to Expense Management 2022 R1 (9.00)

Please note that Expense Management 2022 R1 (9.00) is available from Business Central April 2019 (v14, FOB-based) and newer. This means that any client installations running versions prior to that version will not be able to upgrade to 9.00. Instead they should be upgraded to version 8.00 as this version will continue to be supported with service packs beyound the normal product life cycle (2 years).
