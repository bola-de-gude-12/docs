...
When upgrading from Document Capture 7.00 and/or Expense Management 7.00 to version 8.00, use the regular upgrade procedure described in [Manual Upgrade from Version 7.00 to Version 8.00](../../../../../../Continia%20Expense%20Management/Development%20and%20Administration/On-Premises/Upgrade/Expense%20Management%202022%20R1%20\(FOB\)/Application%20and%20data/@EM-30/) or [Automated Data Upgrade from Version 7.00 to Version 8.00](../../../../../../Continia%20Expense%20Management/Development%20and%20Administration/On-Premises/Upgrade/Expense%20Management%202022%20R1%20\(FOB\)/Application%20and%20data/@EM-31/).
...
Migration from FOB-based version of NAV/BC to an on-premises extension and/or online: See [Upgrading NAV/Business Central with Expense Management Installed](../../../../../../Continia%20Expense%20Management/Development%20and%20Administration/On-Premises/Upgrade/Expense%20Management%202022%20R1%20\(FOB\)/Application%20and%20data/@EM-107/) and [Migrating Expense Management from Business Central On-Premises to Cloud](../../../../../../Continia%20Expense%20Management/Development%20and%20Administration/On-Premises/Upgrade/Expense%20Management%202022%20R1%20\(FOB\)/Application%20and%20data/@EM-112/).
...
> \[!NOTE] This task is not relevant if you're upgrading from DC6.00.x or DC6.50.x or if you're upgrading from EM4.00.x or EM6.50.x.
...
* "_One or more companies have a wrong activation state. Run page 6086102 "CDC Company Registration Upg." to update the companies activation state, and then rerun the pre-migration to continue the upgrade process_."
...
> \[!IMPORTANT] Only start the upgrade in a company with either Document Capture or Expense Management activated.
...
> \[!NOTE] The installer will update the add-ins folder (Client and/or Server) on the standard installation path. Therefore, if your installation path differs from the standard Microsoft path, make sure you copy the new add-in folder to the folder where your installation resides.
...
> \[!IMPORTANT] Before doing object modifications or starting the data upgrade, make sure you back up the database.
...
3. Compile all Document Capture and Expense Management objects (Version List filter \*DC\*|\*EM\*|\*CC\*|\*DN\*). When using NAV 2015 or a newer version, set Synchronize Schema to “Later”. Some Document Capture/Expense Management objects will not compile and will be deleted later in the upgrade process.
4. Compile all MenuSuites (not only Document Capture and Expense Management).
...
[Manual Upgrade from Version 7.00 to Version 8.00](../../../../../../Continia%20Expense%20Management/Development%20and%20Administration/On-Premises/Upgrade/Expense%20Management%202022%20R1%20\(FOB\)/Application%20and%20data/@EM-30/)\
[Automated Data Upgrade from Version 7.00 to Version 8.00](../../../../../../Continia%20Expense%20Management/Development%20and%20Administration/On-Premises/Upgrade/Expense%20Management%202022%20R1%20\(FOB\)/Application%20and%20data/@EM-31/)
