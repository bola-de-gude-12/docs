---
title: Upgrading to Continia Expense Management 2024 R2 (25.00) for FOB versions
date: 11-07-2025
description: Learn how to upgrade Expense Management for FOB versions of Microsoft Dynamics 365 Business Central
id: EM-262
lang: en
---

# Upgrading to Continia Expense Management 2024 R2 (25.00) for FOB versions
...
Expense Management 2024 R2 (25.00) is only available if you're using one of the following versions of Business Central:
...
> [!NOTE]
> If you have multiple Continia solutions installed in a FOB version of Business Central and want to upgrade one or more of these solutions, you must take certain steps when importing objects. For more information, see [Upgrading with Multiple Continia Solutions Installed (FOB)](@EM-251).

Use the following table to determine the tasks you must carry out for your particular scenario so you can upgrade your old version of Expense Management to Expense Management 2024 R2 (25.00).

## Upgrade to Expense Management 2024 R2 (25.00)
