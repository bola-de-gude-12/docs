---
title: Upgrading to Continia Expense Management 2023 R2 (12.00) for FOB versions
date: 29-09-2023
description:  
id: EM-186
lang: en
...
# Upgrading to Continia Expense Management 2023 R2 (12.00) for FOB versions
...
The table below enables you to determine exactly what tasks must be carried out for your particular scenario in order for you to upgrade your old version of Expense Management to Expense Management 2023 R2 (12.00).

> [!IMPORTANT]
> Note that Expense Management 2023 R2 (12.00) is only available if you're using one of the following versions of Business Central:
...
> This means that clients using older NAV/BC versions will not be able to upgrade to EM12.00. Instead, they must upgrade to EM8.00, as this version will continue to be supported with service packs. 
...
## Upgrade to Expense Management 2023 R2 (12.00)
...
| Full upgrade from the following versions: <ul><li>Expense Management 8.00</li><li>Expense Management 9.00</li><li>Expense Management 10.00</li><li>Expense Management 11.00</li></ul> | From these versions, you can upgrade directly to EM12.00 using [this guide](../application-and-data/from-versions-8001100/manual-upgrade). |
