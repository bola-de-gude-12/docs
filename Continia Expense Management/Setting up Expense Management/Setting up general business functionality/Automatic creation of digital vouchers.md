---
title: Expense Management automatically create digital vouchers
date: 28-07-2025
description:
id: EM-223
lang: en
...
# Automatically create digital vouchers
...
| Business Central version | Setup |
| --- | --- |
...
| [BC v23.2 and later](#expense-management-setup-process-for-bc-v232-and-later) | Expense Management checks the **Digital Voucher Entry Setup** to determine if the feature has been enabled for the type of document that's registered. |

When you enable the feature and register a purchase document, Expense Management will automatically copy all attached files into **Incoming Documents** in the open purchase document, where they'll be listed as digital vouchers. This means that the files listed here are by default the same as the ones listed under **Attachments** >**General**. However, there's no further link between these two sections, meaning that if you decide to delete a file in either one of them, the other section won't be automatically updated accordingly – the deleted file will still appear here.
...
To set up Expense Management to automatically create digital vouchers for older versions of Business Central (BC v14 to BC v23.1):

1. Search for {{search}} **Expense Management Setup**.
1. Under **General**, go to **Digital Vouchers**.
...
To set up Expense Management to automatically create digital vouchers for [purchase allocations](@DC-41) for new versions of Business Central (BC v23.2 and later):

1. Search for {{search}} **Expense Management Setup**.
1. Under **General**, go to **Digital Vouchers**.
1. In **Status**, click **Not configured**. This takes you to the Business Central standard page **Digital Voucher Entry Setup**. For more information, see the Microsoft guide, [Set up digital vouchers](https://learn.microsoft.com/en-us/dynamics365/business-central/across-how-setup-digital-vouchers).
