...
date: 06-12-2021
description: Learn how to set up a transaction template to determine how bank transaction files are processed.
id: EM-42
lang: en
---
...
3. On the action tab, select **Related** > **Bank** > **Transaction Template**. 

4. In the **General** FastTab, fill out the information as required. 

5. The following list outlines specific fields that may require some explanation:
