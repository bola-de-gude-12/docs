...
1. Search {{search}} for **Payment Types**, then select the related link.
...
1. Search {{search}} for **Expense User Groups**, then choose the related link.
1. Select an expense user group.
1. On the action bar, select **Payment Types**.
1. Under **Payment Type**, select a payment type. Repeat this step in the next empty field for each payment type you want to add to this expense user group.

## To assign expense users or expense user groups to a payment type

To assign expense users or expense user groups to a payment type:

1. Search {{search}} for **Payment Types**, then choose the related link.
1. Select a payment type.
1. On the action bar, select **Payment Type** > **Effective Users**.
