...
date: 18-09-2025
description: List of features and bug fixes for each version of Expense Management 2021 R1
id: EM-363
lang: en
---
...
| <span style="white-space: nowrap;">Functional area</span> | Description | ID |
| --- | --- |  --- |
| Expenses|<span>We have added the following Event Publishers<br> Codeunit 6086308 CEM Expense Inbox-Transfer <ul><li>OnAfterExpenseInboxTransfer </li> </ul> |41366|
