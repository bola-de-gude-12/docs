---
title: Frequently Asked Questions About Credit Card Transactions
date: 09-07-2024
description: Frequently asked questions about the Credit Card Transactions
id: EM-246
lang: en
---

# Credit Card Transactions FAQ
In this section, you can find answers to some of the most frequently asked questions about credit card transactions.

## Is it possible to add one credit card to multiple expense users?
...
You can read about this in [Add one credit card to multiple expense users](@EM-249). 