---
title: Can I use a Vendor as Posting Account Type on Credit Card Transactions?
date: 16-10-2023
description: 
id: EM-194
lang: en
...
# Can I use a Vendor as Posting Account Type on Credit Card Transactions?

## Question

I want to use a vendor as posting account type on credit card transactions. Can I do that?

## Answer

Yes, credit card transactions can be posted to a vendor. However, when doing that, there are a few things you *can't* do:
...
Let's get going with setting a vendor as posting account type on credit card transactions:
