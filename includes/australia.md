...
| B2B          | No legislation is in place. <br /><br />Business are encouraged to start using the PINT A-NZ format. <br /><br />{{checkmark}} *Supported by Document Capture*<br />*Not supported by Document Output.* | There is no official timeline communicated changing the current state. |
