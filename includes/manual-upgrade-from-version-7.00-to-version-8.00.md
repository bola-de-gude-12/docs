...
2. Compile all Document Capture and Expense Management objects (Version List filter \*DC\*|\*EM\*|\*CC\*|\*DN\*). When using NAV 2015 or a newer version, set Synchronize Schema to “Later”. Some Document Capture/Expense Management objects will not compile – they will be deleted later in the upgrade process.
...
4. If you continue to use Continia Web Portal on-premises, then create a new Web Site in IIS or update the existing one.
