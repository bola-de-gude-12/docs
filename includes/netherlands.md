...
| ---------------- | ------------------------------------------------------------ | ------------------------------------------------------------ |
| B2G              | As of April 2019, it is required by law that all public authorities are connected to the Peppol eDelivery network. </br><br />{{checkmark}} *Supported by Document Capture.*<br />{{checkmark}} *Supported by Document Output.* | As an EU member, the Netherlands is expected to eventually align with ViDA, including mandatory electronic invoicing, but no immediate plans exist. |
| B2B              | Electronic invoicing is possible using Peppol eDelivery.</br><br />{{checkmark}} *Supported by Document Capture.*<br />{{checkmark}} *Supported by Document Output.* | As an EU member, the Netherlands is expected to eventually align with ViDA, including mandatory electronic invoicing, but no immediate plans exist. |
