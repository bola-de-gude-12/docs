...
Continia has developed a PowerShell script that makes it easy for you to install and upgrade Continia Document Capture and other Continia apps in a singletenant environment. For more information, see [Installing Continia Document Capture On-Premises](../../../Continia%20Document%20Capture/Development%20and%20Administration/On-Premises/@DC-51/) and [Upgrading Continia Document Capture for app versions of Business Central](../../../Continia%20Document%20Capture/Development%20and%20Administration/On-Premises/@DC-6/).
...
> \[!NOTE] For both guides, note that the Document Capture OnPremise app is optional. The app gives you access to features only available in on-premises installations of Business Central, and it's necessary if you want to use the document storage type **File System** or the on-premises OCR service, which also requires access to the file system.
>
...
[Installing Continia Document Capture On-Premises](../../../Continia%20Document%20Capture/Development%20and%20Administration/On-Premises/@DC-51/)\
[Upgrading Continia Document Capture for app versions of Business Central](../../../Continia%20Document%20Capture/Development%20and%20Administration/On-Premises/@DC-6/)
