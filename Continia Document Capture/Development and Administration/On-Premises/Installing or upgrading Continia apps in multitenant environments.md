...
Continia has developed a PowerShell script that makes it easy for you to install and upgrade Continia Document Capture and other Continia apps in a singletenant environment. For more information, see [Installing Continia Document Capture On-Premises](@DC-51) and [Upgrading Continia Document Capture for app versions of Business Central](@DC-6).
