...
This section provides details on how to upgrade to the latest version of Continia Document Capture in the on-premises version of Microsoft Dynamics 365 Business Central (including guidelines on how to migrate from on-premises to the cloud). For guidelines for the online version of Business Central, see [Upgrading to the latest version (online)](@DC-451).
...
>[!NOTE]
>The last FOB version of Document Capture is 2024 R2 (25.00). On-premises users can install the app version of Document Capture 2025 R2 (27.00).
