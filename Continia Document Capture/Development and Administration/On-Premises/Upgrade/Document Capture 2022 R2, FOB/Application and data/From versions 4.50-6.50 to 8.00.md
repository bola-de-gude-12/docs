...
When upgrading from Document Capture 7.00 and/or Expense Management 7.00 to version 8.00, please use the regular upgrade procedure described in [Manual Upgrade from Version 7.00 to Version 8.00](@DC-94) or [Automated Data Upgrade from Version 7.00 to Version 8.00](@DC-105).
