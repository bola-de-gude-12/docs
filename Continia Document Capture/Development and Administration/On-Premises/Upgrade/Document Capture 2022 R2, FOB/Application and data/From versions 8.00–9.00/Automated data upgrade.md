---
title: Automated Data Upgrade from Version 8.00-9.00 to Version 10.00
date: 28-09-2022
id: DC-96
lang: en
---
...
With Document Capture version 10.00 and Expense Management version 10.00, Continia Software is releasing a combined upgrade guide that our partners can use to upgrade Document Capture 8.00-9.00, Expense Management 8.00-9.00 or a system with both Document Capture 8.00-9.00 and Expense Management 8.00-9.00 installed.

> \[!IMPORTANT] Note that Document Capture 2022 R2 (10.00) is only available if you're using Business Central April 2019 (v14, FOB-based) or newer versions. This means that clients using older NAV/BC versions will not be able to upgrade to DC10.00. Instead, they must upgrade to DC8.00, as this version will continue to be supported with service packs.
...
If you are looking for the manual Pre and Post Upgrade process, please refer to [Manual Upgrade from Versions 8.00–9.00 to Version 10.00](../../../../../../../Continia%20Document%20Capture/Development%20and%20Administration/On-Premises/Upgrade/Document%20Capture%202022%20R2,%20FOB/Application%20and%20data/From%20versions%208.00%E2%80%939.00/@DC-95/).

If you are using Document Capture or Expense Management in Microsoft Business Central Cloud, the main upgrade will be performed automatically when you install Document Capture 10.00 and/or Expense Management 10.00.

Migration from FOB-based version of NAV/BC to On-Premises Extension and/or Cloud: See [Upgrading NAV/Business Central with Document Capture Installed](../../../../../../../Continia%20Document%20Capture/Development%20and%20Administration/On-Premises/Upgrade/Document%20Capture%202022%20R2,%20FOB/Application%20and%20data/From%20versions%208.00%E2%80%939.00/@DC-7/) and [Migrating Document Capture from Business Central On-Premises to Cloud](../../../../../../../Continia%20Document%20Capture/Development%20and%20Administration/On-Premises/Upgrade/Document%20Capture%202022%20R2,%20FOB/Application%20and%20data/From%20versions%208.00%E2%80%939.00/@DC-106/).
...
Please be sure that the current system is running one of the supported versions of Document Capture or Expense Management listed in the summary section. If not, it is very important you follow the upgrade guide from an earlier version to DC8.00-9.00 and or EM8.00-9.00. Previous upgrade guides can be found [here](../../../../../../../Continia%20Document%20Capture/Development%20and%20Administration/On-Premises/Upgrade/Document%20Capture%202022%20R2,%20FOB/Application%20and%20data/From%20versions%208.00%E2%80%939.00/@DC-92/).
...
Import the new DC10.00 / EM10.00 objects from the product folder. Please note, some objects may show a warning during import as some parts of the new Version List has changed format. Use “**Replace All**” in Import Worksheet. Set Synchronize Schema to “**Later**” during object import.

## Task 6: Data upgrade

Follow below to complete the Post-Upgrade step:

1. Import the object package named “BC14 - DC8.00-DC9.00 to DC10.00, EM8.00-EM9.00 to EM10.00 – Direct Upgrade Post”. Use “Replace All” in Import Worksheet. Set Synchronize Schema to “**Later**” during import.
