...
> [!IMPORTANT]
> Note that Document Capture 2024 R2 (25.00) and Expense Management 2024 R2 (25.00) are only available if you're using one of the following versions of Business Central:
...
>   This means that clients using older NAV/BC versions will not be able to upgrade to DC25.00/EM25.00. Instead, they must upgrade to DC8.00, as this version will continue to be supported with service packs.
