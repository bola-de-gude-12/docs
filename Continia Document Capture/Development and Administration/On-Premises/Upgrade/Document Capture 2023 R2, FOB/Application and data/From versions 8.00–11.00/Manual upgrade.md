---
title: Manual Upgrade from Versions 8.00–11.00 to Version 12.00
date: 17-01-2025
lang: en
...
This upgrade guide describes the manual upgrade of Document Capture and Expense Management. If you are looking for a more automated process, please refer to \[Automated Data Upgrade from Versions 8.00–11.00 to Version 12.00]\(Automated data upgrade.md). That document describes how to upgrade Document Capture or Expense Management using the new Data Upgrade tools from Microsoft.
...
Migration from FOB-based version of NAV/BC to on-premises extension and/or online: See [Upgrading NAV/Business Central with Document Capture Installed](../../../../../../../Continia%20Document%20Capture/Development%20and%20Administration/On-Premises/Upgrade/Document%20Capture%202023%20R2,%20FOB/Application%20and%20data/From%20versions%208.00%E2%80%9311.00/@DC-7/) and [Migrating Document Capture from Business Central On-Premises to Cloud](../../../../../../../Continia%20Document%20Capture/Development%20and%20Administration/On-Premises/Upgrade/Document%20Capture%202023%20R2,%20FOB/Application%20and%20data/From%20versions%208.00%E2%80%9311.00/@DC-106/).
...
Please be sure that the current system is running one of the supported versions of Document Capture or Expense Management listed in the summary section. If not, it is very important that you follow the upgrade guide from an earlier version to DC4.50 and or EM2.60. Previous upgrade guides can be found [here](../../../../../../../Continia%20Document%20Capture/Development%20and%20Administration/On-Premises/Upgrade/document-capture-2023-r2-fob/).
...
Import the new DC12.00/EM12.00 objects from the product folder. Use “**Replace All**” in Import Worksheet. Please note, some objects may show a warning during import as some parts of the new Version List have changed format. Set Synchronize Schema to “**Later**” during object import.
