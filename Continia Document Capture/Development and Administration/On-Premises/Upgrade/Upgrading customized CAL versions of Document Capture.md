...
date: 29-09-2025
description: How to upgrade Continia Document Capture and Continia Expense Management from C/AL code customizations to AL extensions.
id: DC-113
lang: en
---
...
> [!IMPORTANT]
> To ensure a consistent migration to BC v25, Expense Management must be installed even if it isn't used in the database. When the migration is complete, you can uninstall Expense Management again if needed.
