...
> [!NOTE]
> Such notifications are only displayed for users of [on-premises OCR](#on-premises-ocr), as there's no page-processing limit as such for Continia Cloud OCR. However, seeing that the Continia Cloud OCR base license includes a maximum of 1,000 OCR pages per month and that you'll be charged a minor fee for any pages processed in excess of that, it may still be relevant for you to keep an eye on your page consumption. You can easily do so in the **Document Capture Setup**, as described below under [Continia Cloud OCR](#continia-cloud-ocr).
...
1. On the **OCR License Pages** FastTab, you can check the following details related to your OCR page consumption:
...
1. Under **Warning Pages**, enter the number of documents you think should remain in order for a notification to be triggered.
...
[Configuring On-Premises OCR](@DC-150)  
[Continia Notifications](@DC-131)  
