...
>
> * **Use AI as line recognition method** - see [To use AI line recognition](<Enhanced line recognition.md#to-use-ai-line-recognition>) below.
> * **Enable line capture to span multiple lines** - see [To capture lines spanning multiple rows](<Enhanced line recognition.md#to-capture-lines-spanning-multiple-rows>) below.
