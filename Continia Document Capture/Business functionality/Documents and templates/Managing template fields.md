...
3. On the action bar, click **Template** and then **Add Template Field** to open the **Template Field List**.
...
1. Search ({{search}}) for and select **Document Categories**.
2. Select the code of the relevant document category – in this case **PURCHASE** – to open the document journal.
3. On the action bar, click **Template** and then **Remove Template Field** to open the **Template Field List**.
