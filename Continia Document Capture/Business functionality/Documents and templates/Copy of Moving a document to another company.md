...
date: 01-04-2025
description: How to move documents between different companies.
id:
lang: en
---
...
> [!IMPORTANT]
> For the following guide to work, you must have more than one company set up in Business Central – otherwise the **Move to Company** action isn't available. Also, Document Capture must be installed, activated, and set up correctly in all companies that you want to move documents between.
...
1. On the **Move to Company** page, in the **Name** column, select the name of the company that you want to move the selected document to.
1. In the **Document Category Code** column, select the category code that you want to move the selected document to. If the same document category exists in the destination company, the category code is automatically filled out.
...
1. Follow the guide in [Setting up company identification texts](@DC-443#to-set-up-company-identification-texts) to set up a number of company identification texts, that is, free-text keywords that you can map to specific companies.
1. Make sure that Document Capture has been activated and set up in both of the companies that you want to move documents between.
1. Search ({{search}}) for and select **Document Categories**.
