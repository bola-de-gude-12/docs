...
* Document Capture wasn't activated or set up correctly in the destination company. To solve this, click **OK** to close the dialog box, and then make sure that Document Capture is activated and fully functional in all relevant companies.
...
1. On the **OCR Processing** FastTab, under the **Split PDF Documents** section, enable the **Auto Move to Company** setting.
1. In the **Doc. with Unidentified Company** setting, select the desired behavior when the correct company can't be identified in an imported document.
