...
The G/L Documents category – GLDOC – enables Continia Document Capture to OCR-process and add documents to G/L entries as attachments, making them searchable. The G/L entries are amended in Microsoft Dynamics 365 Business Central once you register the document.
...
3. On the **Templates** FastTab, select the Master template and, in the related action bar, select **Copy**.
4. In the **Copy Template** dialog box, set the **New Type** field to the blank value. Then, select **OK**.
...
1. Search ({{search}}) for and select **Document Categories**.
2. On the **Document Categories** page, select the **GLDOC** code to open the G/L Documents category.
...
4. In the dialog box that opens, select the desired template. Then, select **OK**.
5. On the **Document Header** FastTab, enter the document number in the **Document No.** field. Alternatively, select the three dots by this field to choose the invoice you want to attach the incoming document to. 
