...
2. On the **General** FastTab, specify if you want eDocuments to handle incoming eBilling documents. You can also toggle test mode. For more information, see [To enable test mode](<Copy of Setting up Continia eDocuments.md#to-enable-test-mode>).
