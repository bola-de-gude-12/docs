...
lang: en
description: >-
  How purchase invoices and credit memos are automatically matched against
  related documents
---
...
To set up header matching, see [Configuring automatic matching](../../../Continia%20Document%20Capture/Business%20functionality/Order%20and%20receipt%20matching/@DC-68/). To set up line matching, see [Setting up line matching](../../../Continia%20Document%20Capture/Business%20functionality/Order%20and%20receipt%20matching/@DC-69/).

> \[!TIP] Document Capture supports the matching of an incoming invoice to one or more purchase receipts and/or purchase orders, be it on the header level or the line level. Document Capture can also match credit memos to one or more return shipments and/or return orders.
...
*   Open quantity:
    ...
    * For receipt lines, **Qty. Rcd. Not Invoiced** must be other than zero.
    ...
    > \[!NOTE] This filter is applied to identify document lines that haven't yet been invoiced.
...
> \[!NOTE] For invoices, Document Capture searches for matching order lines and receipt lines, whereas for credit memos it looks for matching return order lines and return shipment lines. The following list of search methods is based on invoices, for descriptive purposes.
>
...
> \[!NOTE] In the document journal, under **Document Header**, you can retrigger the automatic matching process by manually changing the identified **Order No.** or the **Amount Excl. VAT**, if necessary.
...
4. If necessary, [assign a vendor](../../../continia-document-capture/business-functionality/documents-and-templates/working-with-paper-and-pdf-documents/#changing-a-documents-associated-vendor) to the document.
5. On the action bar, click **Match Lines** to open the **Invoice Matching** page (or the **Credit Memo Matching** page for credit memos).
6. On the action bar, click **Home** > **Perform Match**.
