...
This change will add lookup functionality to template field translations, provided that the field being translated is a lookup template field. If you use the field translation feature often, this addition will save time and reduce the number of input errors.
