...
1. Under **Purchase Allocation**, enable purchase allocation by toggling the **Enable** switch.
...
1. Enable automatic creation and posting of purchase allocation entries by toggling the **Post Automatically** switch.
...
1. Select the three dots on the right of the **Payable Account (Allocation)** field to open the **G/L Account List**. In the list, under **No.**, select the account that you want to assign to the selected table line.
