...
To be able to add approvers to your approval flow, you must [set them up](../../../Continia%20Document%20Capture/Setting%20up%20Document%20Capture/Setting%20up%20document%20approval/@DC-23/) first. Once set up, the approvers will be available for selection in the **Continia User List**, as described below.

> \[!NOTE] Regarding [four-eye approval](../../../Continia%20Document%20Capture/Setting%20up%20Document%20Capture/Setting%20up%20document%20approval/@DC-35/): When you set up and [assign an approval flow](../../../Continia%20Document%20Capture/Setting%20up%20Document%20Capture/Setting%20up%20document%20approval/@DC-33/), four-eye approval doesn't apply even if it has been enabled.

## To set up an approval flow

1. Choose the \{{search\}} icon, enter **Approval Flows**, and then choose the related link.
2. On the action bar, click **New** to add an approval flow.
...
5. Under **Selection Method**, specify how approvers are to be selected for the approval of documents that have this approval flow code applied. For more information, see [Adding amount limits to an approval flow](<Creating approval flows.md#adding-amount-limits-to-an-approval-flow>) below.
6. Under **No. of Approvers**, select the number (**0** for new flows) to open the **Approvers** page.
7. On the action bar, click **New** to add an approver.
...
[Using Approval Flows](../../../Continia%20Document%20Capture/Setting%20up%20Document%20Capture/Setting%20up%20document%20approval/@DC-33/)\
[Continia User Setup for Approvals](../../../Continia%20Document%20Capture/Setting%20up%20Document%20Capture/Setting%20up%20document%20approval/@DC-23/)
