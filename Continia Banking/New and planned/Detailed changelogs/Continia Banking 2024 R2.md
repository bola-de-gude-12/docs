...
_Release date, online: July 11, 2025_\
&#xNAN;_&#x41;pp version: 25.9.0_
...
_Release date, on-premises: June 27, 2025_\
&#xNAN;_&#x56;ersion: 25.8.0_
...
_Release date, online: April 2, 2025_\
&#xNAN;_&#x41;pp version: 25.6.0_
...
_Release date, online: March 10, 2025_\
&#xNAN;_&#x41;pp version: 25.5.0_
...
_Release date, online: February 14, 2025_\
&#xNAN;_&#x41;pp version: 25.4.0_
...
| Payment Export      | Integrated the ability to switch between standard and advanced payment export modes at the journal batch level, ensuring flexibility in payment processing. For more information, see the [The Advanced Payment Suggestion Option](../../../Continia%20Banking/New%20and%20planned/Detailed%20changelogs/@CB-145/) article.                                                                                                                                                                                                                      | 63197 |
...
| Payment Import      | Modified the import process for CAMT.054 and CAMT.053 files to allow reimporting of lines into the Bank Transaction Line. For more information, see the [Enabling Reimport of Bank Statement Files](../../../Continia%20Banking/New%20and%20planned/Detailed%20changelogs/@CB-183/) article.                                                                                                                                                                                                                                                     | 62833 |
...
_Release date, online: January 23, 2025_ _App version: 25.3.2_
...
_Release date, online: January 14, 2025_ _App version: 25.3.1_
...
_Release date, online: January 13, 2025_\
...
_Release date, online: January 2, 2025_\
...
_Release date, online: December 20, 2025_\
...
_Release date, online: December 13, 2024_\
&#xNAN;_&#x41;pp version: 24.4.0 and 25.2.0_
...
_Release date, online: November 20, 2024_\
&#xNAN;_&#x41;pp version: 24.3.0 and 25.1.1_
...
_Release date, online: November 17, 2024_ _App version: 24.3.0 and 25.1.0_
...
| Payment Import      | Added a proprietary bank transaction code issuer for Deutsche Bank with issuer code _DK_ on the setup server.                                                                                                        | 60502  |
...
_Release date, online: October 24, 2024_\
&#xNAN;_&#x41;pp version: 24.2.3 and 25.0.3_
...
_Release date, online: October 3 and 8, 2024_\
&#xNAN;_&#x41;pp version: 24.2.1, 24.2.2 and 25.0.1, 25.0.2_

### New or changed functionality

| **Functional Area** | **Description**                                                                                                                                                                                                                                               | **ID** |
| ------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------ |
| Payment Export      | Implemented the ability to add the Charge Bearer () at the Transaction Information level, required for cases such as DACH BTI. The Charge Bearer on Payment Information level will now be cleared when set at the transaction level to ensure correct export. | 60201  |

## Continia Banking 2024 R2

_Release date, online: October 1, 2024_\
&#xNAN;_&#x41;pp version: 24.0.0 and 25.0.0_

### New or changed functionality

| **Functional Area** | **Description**                                                                                                                                                                                                                                                                                                                                | **ID** |
| ------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------ |
| General Application | Continia Banking has been released for BC v24 and BC v25, including [localizations for DK, SE, DE, CH, and AT](../../../Continia%20Banking/New%20and%20planned/Detailed%20changelogs/@CB-56/). For more information, see the [Business Functionality](../../../Continia%20Banking/New%20and%20planned/Detailed%20changelogs/@CB-144/) article. | NA     |
