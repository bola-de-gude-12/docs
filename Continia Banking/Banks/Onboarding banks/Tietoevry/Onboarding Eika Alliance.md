...
3. On the **Bank Accounts** page, select an existing Eika Alliance bank account, or create a new one by selecting **New Bank Account**.
...
6.  Now, select the **Establish connection with Tietoevry** link. This directs you to your online bank, where you can sign up for Eika Alliance bank integration.
...
2. Select **Betalingsprodukter** > **Produktoversikt**.
3. Select **Koble til Økonomisystem**.
4. Select **Continia Software**.
5. In the **Velg kontoer du får innbetalinger på** dropdown menu, select the accounts for the Camt 054C files.
