---
title: Onboarding SpareBank 1 in Continia Banking
date: 25-03-2025
description: Onboarding SpareBank 1 with direct communication in Continia Banking
id: CB-227
lang: en
---
...
SpareBank 1 is an alliance of 15 independent banks across Norway collaborating on a common platform and brand. Customers of a bank in the SpareBank 1 alliance can use Continia Banking to send and retrieve bank files between SpareBank 1 and Microsoft Dynamics 365 Business Central. 

Continia Banking uses the digital service Tietoevry to establish the bank integration with SpareBank 1, and this article covers the steps to set it up.
...
1. Click **Next** to complete the bank account setup. When you return to the bank account overview, you'll see that the bank account status has been updated to Ready. 
...
Before you begin setting up direct communication in Continia Banking, you must request access to the SpareBank 1 bank integration.
