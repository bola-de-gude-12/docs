---
title: Authentication with Bizcuit in Continia Banking
...
To integrate with your Dutch bank, Continia Banking uses Bizcuit: a leading [PSD2](#psd2)-licensed service provider in the Netherlands. Continia Banking integrates seamlessly with Bizcuit, so you can download your bank account statements and initiate payments directly from Microsoft Dynamics 365 Business Central.

> [!NOTE]
>
> The direct communication services supported by Bizcuit depend on your bank. Navigate to your bank from the [Bank Integration overview](@CB-79) to see which services are supported.

This article covers the steps to set up direct communication between your bank and Continia Banking using Bizcuit.
...
To use the services of Bizcuit, you must create an account at Bizcuit. The signup to Bizcuit is handled through the assisted **Bank Account Setup** guide in Continia Banking.  

1. Search ({{search}}) for and select **Bank Account Setup**.

1. On the **Bank Account Setup** page, choose an existing bank account or create a new one.

1. To enable direct communication through Bizcuit, select **Direct Communication** in the **Communication** column, then click **Next**.
...
1. On the **Create Bizcuit Account** page, select the link to start the signup process with Bizcuit. This will open a new tab in your browser, from where you can:
   ...
   >[!NOTE]
   >
   >For detailed information from Bizcuit about creating and linking accounts, please refer to the links in the [Related information](#related-information) section. 

1. When you have created and set up your account with Bizcuit, you'll be directed back to the Continia Banking Bank Account Setup to finish the setup.
