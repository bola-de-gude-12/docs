---
title: Onboarding Handelsbanken GlobalOnLine in Continia Banking
date: 26-06-2025
description: Onboarding Handelsbanken GlobalOnLine with direct communication in Continia Banking.
id: CB-224
lang: en
---
...
As a customer of Handelsbanken, using Handelsbanken GlobalOn-Line with Global Gateway SFTP communication, you can send and retrieve bank files between Handelsbanken and Microsoft Dynamics 365 Business Central using Continia Banking.

> [!IMPORTANT]
>
> Continia Banking does not support accounts set up with the Corporate Signing agreement. This agreement requires a PGP key for functionality, which is not supported by Continia Banking.

This article explains how to establish direct communication between Handelsbanken GlobalOn-Line and Continia Banking. It consists of the following phases:
...
To establish direct communication between Continia Banking and Handelsbanken, you must contact your Cash Management adviser at your bank and request access to the bank's online banking solution, and subscribe to the following services: 
...
Once you have received the agreement from Handelsbanken GlobalOn-Line, you can proceed with setting up direct communication in Continia Banking.
...
1. On the **Create certificate** page, fill in the fields as requested. Continia Banking will auto-fill in most of the fields with existing information from Business Central. Type in the information that you received in the email from the bank. 
