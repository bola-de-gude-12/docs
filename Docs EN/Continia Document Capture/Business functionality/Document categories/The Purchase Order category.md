...
The Purchase Order category – **PURCHORDER** – in Continia Document Capture enables you to automatically create and update purchase orders based on data recognized in another document (typically an order confirmation from a vendor). The purchase orders are created in Microsoft Dynamics 365 Business Central once you register them.
...
1. Click the **PURCHORDER** code to open the document journal for purchase orders.

1. In the list of documents, select the one that you want to use as a basis for the purchase order you're about to create.

1. If the document is related to a new vendor, make sure that there's a vendor and a template associated with it. If not, create the vendor by clicking **Vendor > Vendor Card** on the action bar and filling out the details. Document Capture creates a copy of the related master template, and associates it with the new vendor.
...
1. Go to **[O]rder / [R]eceipt**, and check that the letter **O** is displayed in the **Value** column. If not, enter it manually, and then press **Enter**.
...
2. Click the **PURCHORDER** code to open the document journal for purchase orders.
...
6. Go to **[O]rder / [R]eceipt**, and check that the letter **R** is displayed in the **Value** column. If not, enter it manually, and then press **Enter**.
