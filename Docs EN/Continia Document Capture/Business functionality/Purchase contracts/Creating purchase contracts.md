---
title: Creating purchase contracts in Document Capture
date: 23-07-2025
...
There are three ways to create purchase contracts:
...
In any case, the **Approval Status** of a new purchase contract is set to **Approval Needed** by default – and the **Next Approval Date** is set to **TODAY** to ensure that at least one approval is done.
...
1. Search ({{search}}) for and select **Purchase Contracts**.
   > [!NOTE]
   > You can also open this page from the Business Central Role Center. Under **Purchase Contracts**, click the **All** Cue to open it. Note that the page is called **All** when you access it this way, but in all other respects it's identical with the **Purchase Contracts** page.
...
1. If there's no template associated with the invoice/credit memo, you must assign one by activating field recognition: On the action bar, click **Home** > **Recognize Fields**.
