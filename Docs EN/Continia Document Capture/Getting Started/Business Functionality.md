...
date: 29-09-2025
description: Detailed information on the functionality included in the latest version of Document Capture.
id: DC-49
lang: en
---
...
> [!IMPORTANT]
> Not all features are available in all versions of Document Capture. To see features available per version of Document Capture, refer to [Comparison of features by Document Capture version](@DC-46).
...
| Connect multiple customers and vendors in one go in Continia eDocuments | {{checkmark}} |
...
| Configurable and automatic line-by-line matching<a href="#footnote-1.1"><sup>1</sup></a> | {{checkmark}} |
...
| Free online hosting with Continia Software<a href="#footnote-2.1"><sup>1</sup></a> | {{checkmark}} |
| Direct connection to Business Central using web services (full data consistency)<a href="#footnote-2.1"><sup>1</sup></a> | {{checkmark}} |
| An intuitive UI for users to approve purchase invoices, credit memos, and other business documents<a href="#footnote-2.1"><sup>1</sup></a> | {{checkmark}} |
...
| Configurable account and dimension limitations to simplify selections<a href="#footnote-2.1"><sup>1</sup></a> | {{checkmark}} |
| Have approvals carried out by Business Central limited users | {{checkmark}} |
| Searchable, safe archive<a href="#footnote-2.1"><sup>1</sup></a> | {{checkmark}} |
...
<div class="footnotes">
  <hr />
  <ol>
    <li id="footnote-2.1">Note that you also need the Web Approval Portal to use this feature.</li>
  </ol>
</div>
