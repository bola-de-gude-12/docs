...
Please be sure that the current system is running one of the supported versions of Document Capture or Expense Management listed in the summary section. If not, it is very important you follow the upgrade guide from an earlier version to DC8.00–11.00 and/or EM8.00–11.00. Previous upgrade guides can be found [here](../../../document-capture-2023-r2-fob).
