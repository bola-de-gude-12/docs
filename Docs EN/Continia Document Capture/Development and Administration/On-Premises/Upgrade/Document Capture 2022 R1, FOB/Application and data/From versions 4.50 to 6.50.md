...
After importing the correct pre-upgrade package (replace all), go to either “Document Capture Setup” or “Expense Management Setup” and press “Upgrade Data to Latest Version”. This will perform the pre-upgrade.
...
| Version | Guide |
| --- | --- |
| NAV Server 2009 -> 2009 R2 | Only perform the following steps if you are using Dynamics NAV 2009 -> 2009 R2: <ol><li>Stop &ldquo;Microsoft Dynamics NAV Server&rdquo;. Set it to start up manually.</li><li>Stop &ldquo;Microsoft Dynamics NAV Business Web Services&rdquo; if started. Set it to start up manually.</li><li>Restart the Windows server.</li><li>Using the **Add or remove programs** functionality in Windows, uninstall Document Capture RTC Server Components.</li><li>Install Document Capture RTC Server Components.</li><li>If you haven&rsquo;t installed the Microsoft Dynamics NAV Server in the default location, you must move the Add-ins manually from the default location to the current location of your installation.</li><li>Start &ldquo;Microsoft Dynamics NAV Server&rdquo;. Set it to start up automatically.</li><li>Start &ldquo;Microsoft Dynamics NAV Business Web Services&rdquo;, if needed. Set it to start up automatically.</li></ol> |
| NAV Server 2013 -> BC14 | Only perform the following steps if you are using Dynamics NAV 2013 -> Microsoft Dynamics 365 Business Central April 2019 (BC14): <ol><li>Stop &ldquo;Microsoft Dynamics NAV Server&rdquo;.</li><li>Using the **Add or remove programs** functionality in Windows, uninstall Document Capture RTC Server Components.</li><li>Install Document Capture RTC Server Components.</li><li>If you haven&rsquo;t installed the Microsoft Dynamics NAV Server in the default location, you must move the Add-ins manually from the default location to the current location of your installation.</li><li>Start &ldquo;Microsoft Dynamics NAV Server&rdquo;.</li></ol> |
| NAV Classic Upgrade PC | Only perform the following steps if you are using Dynamics NAV Classic: <ol><li>On the computer where you perform the upgrade, you must uninstall &ldquo;Document Capture Classic Client Components&rdquo; and &ldquo;Document Capture Classic Components (Scanner)&rdquo;</li><li>Install &ldquo;Document Capture Classic Client Components&rdquo;.</li><li>Install &ldquo;Document Capture Classic Components (Scanner)&rdquo; if needed.</li></ol> |
| NAV RTC Upgrade PC | Only perform the following steps if you are using Dynamics NAV RTC: <ol><li>On the computer where you perform the upgrade, you must uninstall Document Capture RTC Client and Document Capture RTC Components (Scanner) using the **Add or remove programs** functionality in Windows.</li><li>Install Document Capture RTC Client.</li><li>Install Document Capture RTC Component (Scanner) if needed.</li><li>If you haven&rsquo;t installed the Microsoft Dynamics NAV RTC Client in the default location, you must move the Add-ins manually from the default location to the current location of your installation.</li></ol> |
...
| Version | Guide |
| --- | --- |
| NAV Classic Clients | Only perform the following steps if you are using Dynamics NAV Classic: <ol><li>Uninstall &ldquo;Document Capture Classic Client Components&rdquo;.</li><li>Uninstall &ldquo;Document Capture Classic Components (Scanner)&rdquo;.</li><li>Install &ldquo;Document Capture Classic Client Components&rdquo;.</li><li>Install &ldquo;Document Capture Classic Components (Scanner)&rdquo; if needed.</li></ol> |
