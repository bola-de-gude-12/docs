---
title: Creating approval flows in Document Capture
date: 15-10-2025
...
> [!NOTE]
> When you set up and [assign an approval flow](@DC-33), four-eye approval doesn't apply even if it has been enabled.

## To set up an approval flow

1. Search ({{search}}) for and select **Approval Flows**.
...
1. In the list, under **Name**, click the three dots on the right to open the **Continia User List**. Select a user from the list, and then click **OK** to close the page.
