...
* [Continia Document Capture](README.md)
  ...
  * [New and Planned](continia-document-capture/new-and-planned/README.md)
    ...
    * [eDocument validation](continia-document-capture/new-and-planned/edocument-validation.md)
    * [Batch import improvements](continia-document-capture/new-and-planned/batch-import-improvements.md)
    * [Item tracking   update order](continia-document-capture/new-and-planned/item-tracking-update-order.md)
