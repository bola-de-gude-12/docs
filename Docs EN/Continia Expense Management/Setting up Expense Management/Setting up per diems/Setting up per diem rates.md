---
title: Setting up Per Diem Rates
date: 22-11-24
description: Learn how to set up per diem rates and sub rates.
id: EM-86
lang: en
---
...
2. Select an existing per diem group, or select **New** in the action bar to create a new per diem group following this [guide](@EM-85).
