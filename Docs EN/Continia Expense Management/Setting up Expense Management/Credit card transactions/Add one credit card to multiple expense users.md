---
title: Add one Credit Card to Multiple Expense Users
date: 05-07-2024
description: Learn how to add one credit card to multiple expense users
id: EM-249
lang: en
---
...
8. Under **Value**, enter the employee name. Make sure that what you enter here uniquely identifies the employee, so you might have to enter a surname in addition to a first name.