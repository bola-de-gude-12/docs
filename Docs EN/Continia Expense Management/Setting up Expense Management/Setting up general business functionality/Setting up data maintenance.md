...
1. Under **General** > **Data Maintenance**, go to the **GDPR Retention Period (Years)** field and specify the number of years you would like the GDPR-related data to be saved.
