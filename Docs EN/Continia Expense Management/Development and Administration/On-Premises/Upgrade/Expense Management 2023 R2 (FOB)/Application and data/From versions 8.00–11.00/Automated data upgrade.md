...
After the upgrade, you must use a new/updated customer license file from Microsoft, and you must restart the Business Central Server to use the new license.
