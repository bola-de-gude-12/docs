...
| ---------------- | ------------------------------------------------------------ | ------------------------------------------------------------ |
| B2G              | Electronic invoicing has been possible since 2018, but it's not mandatory yet.<br /><br />{{checkmark}} *Supported by Document Capture<br />Not supported by Document Output.* | Format changed in 15 November 2024 to PINT A-NZ Billing. Transport platform remained the same.<br/><br/>Since 15 May 2025, the PINT A-NZ format is mandatory – and the ANZ Peppol BIS 3.0 format is no longer maintained. |
| B2B              | Electronic invoicing is possible using Peppol eDelivery. <br /><br />{{checkmark}} *Supported by Document Capture.<br />Not supported by Document Output.* | The government has proposed a non-regulatory approach to promote the use of electronic invoicing. However, no specific timeline has been set for its implementation yet. |
