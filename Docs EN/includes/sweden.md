...
| B2B              | Peppol BIS 3.0 is the standardized format specification used in Sweden. Any B2B transaction can be exchanged between registered Peppol entities, including B2B to B2G.</br><br />{{checkmark}} *Supported by Document Capture.*<br />{{checkmark}} *Supported by Document Output.* | It was suggested in February 2023 to incorporate B2B electronic invoicing into the existing B2G mandate from 2019.</br><br />{{checkmark}} *Supported by Document Capture.*<br />{{checkmark}} *Supported by Document Output.* |
