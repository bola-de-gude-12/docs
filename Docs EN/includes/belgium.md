...
| B2B              | Electronic invoicing between B2B companies is possible through Peppol eDelivery. </br><br />{{checkmark}} *Supported by Document Capture.*<br />{{checkmark}} *Supported by Document Output.* | Electronic invoicing will be mandatory for B2B from January 1st, 2026. Legislation states that B2B must be able to issue and receive e-invoices by this date. </br><br />{{checkmark}} *Supported by Document Capture.*<br />{{checkmark}} *Supported by Document Output.* |
