...
The table below outlines the current regulatory states and future outlooks for B2G, B2B, and B2C (business-to-consumer) sectors.<br>

| Transaction type | **Current regulatory state**                                 | **Regulatory outlook**   |
| ---------------- | ------------------------------------------------------------ | ------------------------ |
| B2G              | Electronic invoicing has been mandatory since 2019. </br><br />Only the National Healthcare System in England, has formally defined to use of Peppol eDelivery Network and formats for electronic invoicing. <br/><br/>The rest of the public sector follows different regulations. These regulations require the use of various exchange formats.</br><br />{{checkmark}} *Supported by Document Capture.*<a href="#footnote-1"><sup>1</sup></a><br />{{checkmark}} *Supported by Document Output.*<a href="#footnote-2"><sup>2</sup></a> | No changes are expected. |
| B2B              | No legislation is in place.</br><br />To exchange electronic invoices between two parties, the exchange method and format must be agreed among them.<br /><br />{{checkmark}} *Supported by Document Capture.*<a href="#footnote-1"><sup>1</sup></a><br />{{checkmark}} *Supported by Document Output.*<a href="#footnote-2"><sup>2</sup></a> | No changes are expected. |
...
<div class="footnotes">
  <hr />
  <ol>    
          <li id="footnote-1">Peppol eDelivery Network supported with Peppol BIS 3.0 Invoice and Ordering.</li>
          <li id="footnote-2">Peppol eDelivery Network supported with Peppol BIS 3.0 Invoice.</li>
