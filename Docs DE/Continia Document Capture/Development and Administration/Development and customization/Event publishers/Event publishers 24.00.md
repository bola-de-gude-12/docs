---
title: Event Publisher für Document Capture 2024 R1 (24.00)
date: 14-04-2025
description: Die vollständige Event Publisher-Liste für Document Capture 2024 R1 (24.00).
id: DC-189
lang: de
---

# Event Publisher für Document Capture 2024 R1 (24.00)

> [!NOTE]
> Mit der Veröffentlichung im Frühjahr 2024 macht Document Capture einen Versionssprung von 12.00 auf 24.00, was bedeutet, dass die Versionen 13.00–23.00 nicht existieren und nie existieren werden. Dies wurde getan, um die Versionierung von Document Capture an die von Microsoft Dynamics 365 Business Central anzupassen.

Die folgenden Event Publisher sind in Continia Document Capture 2024 R1 (24.00) enthalten:
...
| Event type | IntegrationEvent(IncludeSender : `false`, GlobalVarAccess : `false`) |
| Parameters | ReferenceTypeNo: `Code[50]`<br> `var` DataTrans: `Record` "CDC Data Translation"<br> TranslateFrom: `Code[150]`<br> ReferenceType: `Integer`<br> `var` IsHandled: `Boolean` |
| From version | 24.1.0.0 |
