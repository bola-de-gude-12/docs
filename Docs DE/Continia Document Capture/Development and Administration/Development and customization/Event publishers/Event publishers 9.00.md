---
title: Event Publisher für Document Capture 2022 R1 (9.00)
date: 14-04-2025
description: Die vollständige Event Publisher-Liste für Document Capture 2022 R1 (9.00).
id: DC-47
lang: de
---

# Event Publisher für Document Capture 2022 R1 (9.00)

Die folgenden Event Publisher sind in Continia Document Capture 2022 R1 (9.00) enthalten:
...
| Event type | IntegrationEvent(IncludeSender : `false`, GlobalVarAccess : `false`) |
| Parameters | `var` PurchaseLine: `Record` "Purchase Line" |
| From version | 9.2.0.0 |
...
| Event type | IntegrationEvent(IncludeSender : `false`, GlobalVarAccess : `false`) |
| Parameters | `var` PurchRcptLine: `Record` "Purch. Rcpt. Line" |
| From version | 9.2.0.0 |
