---
title: Event Publisher für Document Capture 2025 R1 (26.00)
date: 27-06-2025
description: Die vollständige Event Publisher-Liste für Document Capture 2025 R1 (26.00).
id: DC-458
language: de
---

# Event Publishers für Document Capture 2025 R1 (26.00)

Die folgenden Event Publisher sind in Continia Document Capture 2025 R1 (26.00) enthalten.
...
|   |   |
| --- | --- |
| Event name | **OnAfterImportDocuments** |
| Event type | IntegrationEvent(IncludeSender : `false`, GlobalVarAccess : `false`) |
| Parameters |  |
| From version | 26.0.0.0 |
...
| Event type | IntegrationEvent(IncludeSender : `false`, GlobalVarAccess : `false`) |
| Parameters | Document: `Record` "CDC Document"<br> ExtDocNo: `Code[250]`<br> `var` Handled: `Boolean`<br> DocumentType: `Integer`<br> DocumentDate: `Date` |
| From version | 26.0.0.0 |
...
| Event type | IntegrationEvent(IncludeSender : `false`, GlobalVarAccess : `false`) |
| Parameters | `var` ApprEntry: `Record` "Approval Entry"<br> `var` ContiniaUserSetup: `Record` "CDC Continia User Setup" |
| From version | 26.0.0.0 |
