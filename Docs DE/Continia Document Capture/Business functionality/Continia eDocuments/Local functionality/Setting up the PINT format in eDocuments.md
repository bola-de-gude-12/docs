...
1.	Choose the {{search}} icon, enter **Set Up Document Capture**, and then choose the related link. Select **Next** in the dialog box that opens.
...
5.	Select **Next** and wait for the system to import the configuration.
...
1.	Choose the {{search}} icon, enter **Continia Delivery Network Participations**, and then choose the related link.
2.	On the |**Continia Delivery Network Participations** page, select the desired participation and, in the action bar, select **Edit**.

   >[!NOTE]
   >If you don’t have any participations set up, refer to [Setting up the Continia Delivery Network](@DC-75).

3.	In the **Continia Delivery Network Onboarding** assisted setup guide, select **Next** until you reach the **Peppol Registration** step.
