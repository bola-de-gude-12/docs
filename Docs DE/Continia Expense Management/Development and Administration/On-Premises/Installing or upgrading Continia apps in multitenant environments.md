...
Continia hat ein PowerShell-Skript entwickelt, mit dem Sie Continia Expense Management und andere Continia-Apps in einer Single-Tenant-Umgebung problemlos installieren und aktualisieren können. Weitere Informationen finden Sie unter [Continia Expense Management On-Premises installieren](@EM-138) und [Continia Expense Management für App-Versionen von Business Central aktualisieren](@EM-254).
...
[Continia Expense Management On-Premises installieren](@EM-138)  
[Continia Expense Management für App-Versionen von Business Central aktualisieren](@EM-254)
