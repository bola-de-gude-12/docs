---
title: Manuelles Upgrade von Versionen 8.00–12.00 auf Version 24.00
date: 19-03-2024
description: Eine Anleitung zum direkten Upgrade der Versionen 8.00–12.00 auf Version 24.00
lang: de
---
...
In dieser Upgrade-Anleitung wird das manuelle Upgrade von Document Capture und Expense Management beschrieben. Wenn Sie einen automatisierten Prozess suchen, finden Sie weitere Informationen unter [Automatisierte Datenaktualisierung von Versionen 8.00–12.00 auf Version 24.00](Automated data upgrade.md). In diesem Dokument wird beschrieben, wie Sie Document Capture oder Expense Management mit den neuen Data Upgrade-Tools von Microsoft aktualisieren.

> [!IMPORTANT]
> Beachten Sie, dass Document Capture 2024 R1 (24.00) und Expense Management R1 (24.00) nur verfügbar sind, wenn Sie eine der folgenden Versionen von Business Central verwenden:
>
...
>   Dies bedeutet, dass Kunden, die ältere NAV/BC-Versionen verwenden, nicht auf DC24.00/EM24.00 aktualisieren können. Stattdessen müssen sie auf DC8.00/EM8.00 aktualisieren, da diese Version weiterhin mit Service Packs unterstützt wird.

Wenn Sie Document Capture oder Expense Management in Microsoft Dynamics Business Central Online verwenden, wird das Hauptupgrade automatisch durchgeführt, wenn Sie DC24.00/EM24.00 installieren.
...
3. Kompilieren Sie alle Document Capture- und Expense Management-Objekte (Versionslistenfilter \*DC\*|\*EM\*|\*CC\*|\*DN\*|\*BF\*). Stellen Sie die Schemasynchronisierung auf **Später** ein. Einige DC/EM-Objekte werden möglicherweise nicht kompiliert. Sie werden später im Upgrade-Prozess gelöscht.
