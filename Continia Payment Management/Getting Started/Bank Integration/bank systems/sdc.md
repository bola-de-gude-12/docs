...
* Direct communication SDC- refer to the [Onboarding Bank Connect Banks with Direct Communication](@PM-179) article.
* Manual communication SDC - refer to the general [To set up bank accounts to use manual communication](@PM-3#to-set-up-bank-accounts-to-use-manual-communication) article. 
...
| Manual | [KaSel](@PM-123#KaSel "Send payments to your bank from the payment journal" ) | {{cross}}                                    | {{cross}}                                    | [CAMT.054C](@PM-123#CAMT.054C "Import customer payments in the cash receipts journal" )<br />[PBS Sector](@PM-123#PBS "Import NETS PBS FIK DK customer payments in the cash receipts journal." ) | [CAMT.053](@PM-123#CAMT.053 "Reconcile bank statements and import payments" )<br />[.DAT format](@PM-123#DAT "Reconcile bank statements and import payments." ) |
