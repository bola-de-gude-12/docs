---
title: Revolut
description: Integration with the bank system Revolut
date: 05-12-2024
id: PM-291
lang: en
---
...
| <div style="width:175px">Functionality</div>               | Revolut                                               |
| ---------------------------------------------------------- | ----------------------------------------------------- |
| Faster Payment Single                                      | ({{checkmark}}<a href="#footnote-1"><sup>1</sup></a>) |
| Faster Payment Bulk                                        | ({{checkmark}}<a href="#footnote-1"><sup>1</sup></a>) |
| International Single<a href="#footnote-2"><sup>2</sup></a> | ({{checkmark}}<a href="#footnote-2"><sup>2</sup></a>) |
