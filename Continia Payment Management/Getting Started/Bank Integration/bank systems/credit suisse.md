---
title: Credit Suisse and Payment Management
description: PM integration with the bank system Credit Suisse
date: 16-09-2022
id: PM-124
lang: en
---
...
This article lists the file format requirements for the manual communication method. To learn more about how to set up manual communication for Credit Suisse, refer to the [Setting up bank accounts](@PM-3#to-set-up-bank-accounts-to-use-manual-communication) article.
