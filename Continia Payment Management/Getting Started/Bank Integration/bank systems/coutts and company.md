---
title: Coutts and Company in Payment Management
description: PM integration with Coutts and Company.
date: 05-12-2024
id: PM-279
lang: en
---
...
With Payment Management, you can use direct communication to send bank data between Coutts and Company and Microsoft Dynamics 365 Business Central through Yapily, an Open Banking payment service provider.

> [!IMPORTANT]
>
> To set up a connection with this bank, contact [Continia Support](@PM-21). They will assist you with the process.

This article lists the file format requirements for both communication methods. To learn more about how to set direct communication Coutts and Company using Yapily - refer to the [Onboarding Yapily to use Direct Communication](@PM-268).
...
How you can integrate your bank with Payment Management depends on the types of bank communication and files your bank supports. The following table displays what is supported for direct communication Coutts and Company.
...
| Functionality                                              | Coutts and Company                                    |
| ---------------------------------------------------------- | ----------------------------------------------------- |
| Faster Payment Single                                      | ({{checkmark}}<a href="#footnote-1"><sup>1</sup></a>) |
| Faster Payment Bulk                                        | ({{checkmark}}<a href="#footnote-1"><sup>1</sup></a>) |
| International Single<a href="#footnote-2"><sup>2</sup></a> | ({{checkmark}}<a href="#footnote-1"><sup>1</sup></a>) |
