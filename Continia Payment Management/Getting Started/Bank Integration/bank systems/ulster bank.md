---
title: Ulster Bank	
description: Integration with the bank system Ulster Bank
date: 05-12-2024
id: PM-293
lang: en
---
...
## To connect with Ulster Bank manually

When initiating manual communication with Ulster Bank, the following features are supported:
...
| <div style="width:175px">Functionality</div>               | Ulster                                                |
| ---------------------------------------------------------- | ----------------------------------------------------- |
