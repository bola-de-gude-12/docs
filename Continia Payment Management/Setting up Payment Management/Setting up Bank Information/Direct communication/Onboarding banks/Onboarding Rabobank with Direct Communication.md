---
title: Onboarding Rabobank with Direct Communication
...
1. Select **Next**. Now you can make payments and download account statements. To download account statements

The bank account reconciliation using Rabobank uses standard Payment Management reconciliation functionality. For instructions on how to set up the bank accounts reconciliation, refer to the [Setting up Statement Intelligence](@PM-35) article.
