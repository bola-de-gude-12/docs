...
# Onboarding Sparebanken Sør with Direct Communication

Sparebanken Sør is a Norwegian savings bank, headquartered in Kristiansand. Customers of Sparebanken Sør alliance can use the Payment Management Direct Communication service to send and retrieve bank files between Sparebanken Sør and Microsoft Dynamics 365 Business Central. 

Payment Management uses the digital service Tietoevry to establish the bank integration with the Sparebanken Sør bank, and this article covers the steps to set it up.

{{include "pm- kyc-verification-note"}}

For general information on Sparebanken Sør, see the [Sparebanken Sør](@PM-315) article.
...
Before you begin setting up direct communication in Payment Management, you must request the integration using the integration form.
