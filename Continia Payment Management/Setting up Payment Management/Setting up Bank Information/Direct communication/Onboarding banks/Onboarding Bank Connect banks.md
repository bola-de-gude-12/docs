---
title: Onboarding Bank Connect banks
date: 08-08-2022
...
When the agreement with Bank Connect has been established, sign in to your bank and order the files you want to use. To see which files you need to order, navigate to your bank from the [Bank Integration overview](@PM-98).
...
1. Select **Next** to complete the bank account setup. When you return to the Bank Account Overview page, you'll see the status for the bank account has changed to Ready. 
...
[Integration to Bankdata](@PM-117)  
[Integration to BEC](@PM-125)  
[Integration to SDC](@PM-121)  
[Importing and Exporting Bank Files](@PM-123)  
